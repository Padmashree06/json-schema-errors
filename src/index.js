...
import combinedMaximumNormalizationHandler from "./normalization-handlers/combinedMaximum.js";
import combinedMinimumNormalizationHandler from "./normalization-handlers/combinedMinimum.js";
...
setNormalizationHandler("https://json-schema.org/keyword/maximum", combinedMaximumNormalizationHandler);
setNormalizationHandler("https://json-schema.org/keyword/exclusiveMaximum", combinedMaximumNormalizationHandler);
setNormalizationHandler("https://json-schema.org/keyword/draft-04/exclusiveMaximum", combinedMaximumNormalizationHandler);
setNormalizationHandler("https://json-schema.org/keyword/draft-04/maximum", combinedMaximumNormalizationHandler);
setNormalizationHandler("https://json-schema.org/keyword/minimum", combinedMinimumNormalizationHandler);
setNormalizationHandler("https://json-schema.org/keyword/exclusiveMinimum", combinedMinimumNormalizationHandler);
setNormalizationHandler("https://json-schema.org/keyword/draft-04/minimum", combinedMinimumNormalizationHandler);
setNormalizationHandler("https://json-schema.org/keyword/draft-04/exclusiveMinimum", combinedMinimumNormalizationHandler);
